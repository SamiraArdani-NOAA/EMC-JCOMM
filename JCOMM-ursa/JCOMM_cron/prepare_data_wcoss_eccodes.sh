...
# added these two lines to activate conda environment whitin a shell
#source conda_init
#conda activate hera-work
#source /scratch4/NCEPDEV/ovp/Samira.Ardani/modules/env-Ursa/bin/activate
...
#grib_filter=/scratch4/NCEPDEV/ovp/Samira.Ardani/modules/env-Ursa/bin/grib_filter
#grib_set=/scratch4/NCEPDEV/ovp/Samira.Ardani/modules/env-Ursa/bin/grib_set
#grib_count=/scratch4/NCEPDEV/ovp/Samira.Ardani/modules/env-Ursa/bin/grib_count
#grib_ls=/scratch4/NCEPDEV/ovp/Samira.Ardani/modules/env-Ursa/bin/grib_ls
md5sum=/bin/md5sum
...
#	  rm -f ${workdir}/${theDate}/multi_1.glo_30m.t${cyc}z.*.grib2
     ...
     # module load  python/3.11
      #GRIB_VENV_DIR="/scratch4/NCEPDEV/ovp/Samira.Ardani/modules/env-Ursa"
      #if [ ! -d "$GRIB_VENV_DIR" ]; then
  #	  echo "Creating virtual environment at $GRIB_VENV_DIR..."
   # 	  python -m venv "$GRIB_VENV_DIR"
    #  fi
     # source "$GRIB_VENV_DIR/bin/activate"
      #echo "Installing/updating required packages..."
      #pip install --upgrade pygrib numpy xarray
#      export PYTHONPATH=/gpfs/dell2/emc/modeling/noscrub/gwv/py/lib/python:/usrx/local/nceplibs/dev/lib/pygrib/lib/python3.6/site-packages/
          #export PYTHONPATH=/scratch4/NCEPDEV/ovp/Samira.Ardani/modules/env-Ursa/lib/python3.11/site-packages	
